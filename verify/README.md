...
| Registry | Package |
|---|---|
| npm | `@particle-academy/google-sheets-js` (+ `@particle-academy/google-sheets-ui`, resolved transitively) |
...
npm install @particle-academy/google-sheets-js @particle-academy/fancy-flow
